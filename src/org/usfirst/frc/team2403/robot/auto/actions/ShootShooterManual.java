 ...
 *
 */
public class ShootShooterManual implements Action {
	...
	public ShootShooterManual(double rpm, double angle, double time, Turret turret, Lift lift, Intake frontIntake, Intake backIntake){
		this.rpm = rpm;
		this.angle = angle;
		this.time = time;
		this.turret = turret;
